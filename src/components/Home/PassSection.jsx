...
export default function PassSection() {
  ...
  const stats = [
    ...
    {
      label: "작성한 리뷰",
      value: reviewCount === 0 ? "첫 리뷰를 작성해보세요!" : `${reviewCount}개`,
  ...
  return (
    <section className=" mb-10">
      <div className="max-w-[480px] mx-auto relative overflow-hidden bg-white rounded-[2.5rem] p-7 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.08)] border border-slate-100 transition-all hover:shadow-[0_40px_80px_-15px_rgba(49,130,206,0.12)]">
        {/* 장식용 배경 광원 */}
