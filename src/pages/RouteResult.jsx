        ...
        title={
          <div className="flex items-center gap-4 py-1">
            <div className="flex flex-col items-center">
              ...
              <span className="text-[18px] font-black text-slate-400 tracking-tighter">
                {start || "출발지"}
              </span>
            </div>
        ...
        <div className="mb-10 relative">
          ...
          <h3 className="text-[26px] font-black text-slate-900 tracking-tighter leading-tight">
            {isLoading ? (
              ...
              <>
                경로상{" "}
                <span className="text-[#3182CE]">{routeResults.length}개</span>
                의<br />
                휴게소를 찾았습니다.
              </>
            )}
        ...
        {!isLoading && (
          <div className="space-y-0 relative">
            {routeResults.map((item, index) => (
              <FadeIn key={item.stdRestCd} delay={index * 150}>
                <div className="relative pl-10 pb-10 group">
                  ...
                  <div
                    onClick={() => navigate(`/detail/${item.stdRestCd}`)}
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-[14px] font-black text-slate-800">
                            {item.gasolinePrice
                              ? `${item.gasolinePrice.toLocaleString()}원`
                              : "정보없음"}
                          </span>
                        </div>
                        ...
                        <div className="flex flex-col ml-3">
                          ...
                          <span className="text-[14px] font-black text-slate-800">
                            {item.dieselPrice
                              ? `${item.dieselPrice.toLocaleString()}원`
                              : "정보없음"}
                          </span>
                        </div>
                      </div>
